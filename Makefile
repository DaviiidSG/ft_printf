...
# Source files
SRC = ft_printf.c create_buff.c ft_parse_specifier.c ft_print_char.c \
	ft_print_str.c ft_print_ptr.c ft_tostr.c ft_print_int.c \
	ft_print_uint.c ft_print_hex.c
